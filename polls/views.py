...
class IndexView(generic.ListView):
    ...
    def get_queryset(self):
        """Return the last five published options."""
...
def vote(request,question_id):
    ...
    try:
        ...
        # This prevents data fro  being posted twice if a user the hits back button .
